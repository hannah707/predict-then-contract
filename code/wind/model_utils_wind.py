...
def train_models(models, train_loader, use_forecast=False, \
    ...
    model_key = f'wind_{data}_{method}_{exp_key}_{extra_key}'
    ...
    for epoch in range(start_epoch, num_epochs+1):
        ...
        for batch_data in train_loader:
            inputs, dpReal, rpReal, yieldReal, yieldForecast = batch_data
            ...
            if len(models) == 2:
                ...
                [rpPred], yieldPred = preds, yieldForecast
                acc_loss = [loss_fn(rpPred, rpReal)]
            else:
